...
def search_tweets(query:str, search_id: int, db: Session):
    ...
    for tweet in tweets.data:
        if users[tweet.author_id]:
            ...
            create_search_tweet_search(db=db, tweet_search=tweet_search, search_id=search_id)
...
def search_user(username:str, search_id: int, db: Session):
    ...
    create_search_user_search(db=db, user_search=user_search, search_id=search_id)
